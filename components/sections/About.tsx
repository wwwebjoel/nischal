...
const proofStats = [
  { value: "50+", label: "SOAs/ROAs Prepared", color: "#4A90E2" },
  { value: "2+", label: "Years Paraplanning", color: "#C9A84C" },
  { value: "100%", label: "Compliance Record", color: "#4CAF50" },
  { value: "3", label: "Firms Served", color: "#A78BFA" },
];
        ...
        <div className="grid lg:grid-cols-2 gap-12 xl:gap-16 items-start">
          ...
          >
            ...
            <p className="text-[#8B9EC7] text-lg leading-relaxed">
              Paraplanner with 2+ years serving Australian advisory firms. RG 146 compliant,
              ASIC-experienced, and operating on AEST business hours from Nepal.
            </p>
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <p className="text-[#8B9EC7] text-sm leading-relaxed">
                ...
                services. Committed to compliant, client-focused paraplanning support.
              </p>
            </motion.div>
